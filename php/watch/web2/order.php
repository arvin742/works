...
<link href="http://cdn.morrich.cn/cdn/jquery.city/jquery.city.css" rel="stylesheet" type="text/css" />
	...
	<div class="sec02">
		<div class="container">
			...
			<form class="form">
				...
				<div class="info">
					<input id="pid" class="hidden pid" type="text" name="pid" value="<?php echo $pid; ?>">
					<input id="place" class="hidden place" type="text" name="place" value="<?php echo $_SESSION['place']; ?>">
					<p class="h6">产品规格</p>
...
<script src="http://cdn.morrich.cn/cdn/jquery.city/jquery.city.js"></script>
