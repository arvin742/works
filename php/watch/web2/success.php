...
<div class="content success">
	<div class="container">
		...
		<input id="pid" class="hidden" type="text" value="<?php echo $data[0]['pid']; ?>" />
...
<script>
	...
	var pid = $('.success #pid').val(),
		place = $('.success #place').val(),
		ip = returnCitySN ? (returnCitySN.cname + '\n' + returnCitySN.cip) : '未知位置';

	$.ajax({
		url : "./orderController.php?action=orderVisitEnd",
		type : "post",
		dataType : "json",
		data : {'pid': pid, 'ip': ip, 'place': place, 'status': 0},
		success : function(r){
			// console.log(r);
		},
	});
