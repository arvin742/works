...
<div class="content index">
	<div class="container">
		...
		<div class="sec01">
			<div class="htr"><img src="../images/icon-17.jpg" alt="" /></div>
			<a href="./product.php?id=<?php echo $data->banner[0]['pid']; ?>"><img src="<?php echo $data->banner[0]['image']; ?>" alt="banner"/></a>
			...
			<div class="back clearfix">
				...
				<div class="s-btn">
					<a class="btn" href="./product.php?id=<?php echo $data->banner[0]['pid']; ?>">&nbsp;</a>
				</div>
			</div>
		</div>
		...
		<div class="sec-bt slide">
			<img src="../upload/images/image-1.jpg" alt="" />
		</div>
			...
			for($j = count($pro_info) - 1; $j >= 0; $j--){ 
				...
				<div class="col-6 {$status}">
					<div class="main">
						...
						<p class="price">
							<img src="../images/icon-15.png" alt="1折" />
							<cite>特价：</cite><span>¥{$pro_info[$j]['sel_price']}</span>
