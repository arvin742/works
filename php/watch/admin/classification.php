<?php
	...
	require dirname(__FILE__)."/classController.php";

?>

<div class="content nav-body nav-model classification">
	<div class="nav-crumbs">
		<ol class="breadcrumb">
			<li><a href="./index.php">主页</a></li>
			<li><a href="./product.php">商品管理</a></li>
			<li><a href="./classification.php">分类管理</a></li>
		</ol>
	</div>
	...
	<div class="nav-add">
		<div class="add-main">
			<div class="add-htr">
				<p class="add-head">新增分类</p>
				<a class="add-close btn"><i class="fa fa-remove"></i></a>
			</div>
			<div class="add-text">
				<form class="add-form" action="./classController.php?action=insert" method="post">
					<div class="form-group">
						<input class="form-control" type="text" name="c_name" placeholder="名称" required />
					</div>
					<div class="form-group">
						<input class="form-control" type="text" name="c_content" placeholder="图片" />
					</div>
...
return <<<EOF
		<tr>
			...
			<td>
				<span><img src="../upload/images/{$data[$i]['image']}" alt=""></span>
				<input class="form-control" type="text" name="img" value="{$data[$i]['image']}" />
			</td>
			<td>
